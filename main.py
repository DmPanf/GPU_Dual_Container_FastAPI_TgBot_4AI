...
app = FastAPI(title="Counters System API", version="0.1.0", debug=True)  # Инициализация FastAPI
...
@app.get('/info')
def read_root():
    return {'Project 2023': '📟 Counters - АО "Сервис-Недвижимость" [г. Москва, 2023 г.]'}
